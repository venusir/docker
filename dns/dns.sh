...
# 下载配置
wget https://github.com/rqysir609/docker/raw/main/dns_server/dns.zip
...
mv dns/mosdns/etc/mosdns/* /etc/mosdns
mv dns/mosdns/var/mosdns/* /var/mosdns
mv dns/mosdns/v2dat /opt
chmod +x /opt/v2dat
...
# 编辑cron
mkdir /etc/mycron
mv dns/mosdns/mosdns_update.sh /etc/mycron

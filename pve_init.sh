...
deb http://mirrors.ustc.edu.cn/debian ${CODE_NAME} main contrib non-free non-free-firmware
deb http://mirrors.ustc.edu.cn/debian ${CODE_NAME}-updates main contrib non-free non-free-firmware
deb http://mirrors.ustc.edu.cn/debian-security/ ${CODE_NAME}-security main contrib non-free non-free-firmware
EOF
...
echo "***添加Ceph存储库***"
echo "deb http://mirrors.ustc.edu.cn/proxmox/debian/ceph-${CEPH_CODENAME}/ ${CODE_NAME} main" | tee /etc/apt/sources.list.d/ceph.list

图片描述: 2022-03-27-11-54-F9DnXG.png
图片描述: 2022-03-27-11-54-F9DnXG.png
...
图片描述: 2022-03-26-17-27-yqHlMG.jpg
图片描述: 2022-03-26-17-27-yqHlMG.jpg
中继是什么#
...
具体可参考这个 issue：Derper TLS handshake error: remote error: tls: internal error
...
图片描述: 2022-03-27-11-21-dZ5dtZ.png
图片描述: 2022-03-27-11-21-dZ5dtZ.png
查看与通信对端的连接方式：
...
如果你想自己构建 derper 镜像，可以参考我的 GitHub 仓库。
